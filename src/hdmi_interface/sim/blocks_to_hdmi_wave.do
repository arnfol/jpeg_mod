...
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf1
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf1_o
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf1_wr_en
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf2
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf2_o
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf2_wr_en
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf_empty
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf_full
add wave -noupdate -group BUFs /blocks_to_hdmi_tb/i_blocks_to_hdmi/buf_select
...
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/block
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/block_elem
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/block_line
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/rd_cntr
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/rd_cntr_en
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/wr_cntr
add wave -noupdate -group {W&R CNTRs} /blocks_to_hdmi_tb/i_blocks_to_hdmi/wr_cntr_en
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {30105 ns} 0} {{Cursor 2} {109095 ns} 0}
