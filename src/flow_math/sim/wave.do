...
add wave -noupdate -expand -group IN /flow_mult_tb/dut/in_data
add wave -noupdate -expand -group IN /flow_mult_tb/dut/in_mult
...
add wave -noupdate -expand -group OUT /flow_mult_tb/dut/out_data
...
WaveRestoreCursors {{Cursor 1} {15898 ps} 0}
